...
<div class="panel">
    <div class="panel-header">
        ...
        <div style="display:flex; align-items:center; gap:10px;">
            <input type="search" placeholder="Buscar..." data-buscar-tabla="#tablaConductores" style="padding: 5px 8px; border-radius: 6px; border: 1px solid #ccc; font-size: 12px;">
            <span class="contador"><?= count($conductores) ?> conductores</span>
        </div>
    </div>
    <div class="panel-cuerpo">
    <table class="tabla" id="tablaConductores">
    <thead>
        <tr>
            <th>DNI (Usuario)</th>
